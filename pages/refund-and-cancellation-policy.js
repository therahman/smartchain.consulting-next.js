			...
			<div className='container mx-auto max-w-4xl w-full px-5 lg:px-24 py-12 lg:py-24'>
				...
				<div className='pt-9 space-y-2'>
					...
					<div className='space-y-2'>
						<p>
							Smart Chain offers a 30 days refund policy on all Services sold, on all products that fall
							under the refund policy, on all products and services where 30 day refund is mentioned. To
							ensure our customer protection, customers can request a refund within 30 days from the date
							of the purchase.
						</p>
						<p>
							We offer refunds if we are unable to solve the problem in Smart Chain’s
							extension/module/plugins as advertised in the user guide and product demo. It is mandatory
							that the customer must provide us with server access including [ GIT OR FTP access ].
						</p>
						<p>
						...
						<p>
							To request a refund please share the details at our customer support system. Our dedicated
							team will ensure that you will get the refund within 15 business days.
						</p>
						<p>
							Customers must ensure that they have deleted all the copies/files of smart chain software
							from their server/host.
						</p>
				...
				<div className='pt-9 space-y-2'>
					...
					<p>
						If our software is not working properly as advertised and we are unable to fix the problem, in
						that case, the customer may also request a cancellation as a credit. Which they may use in
						another Smart Chains product/service purchase.
					</p>
				</div>
			</div>
		</section>
